...
if __name__ == '__main__':
    ...
    starting = 450 # index of slices, for exmaple, 450, means the from the 450th slice as most of previous slices are empty
    edges = 200 # in the field of view, the edge cropping
