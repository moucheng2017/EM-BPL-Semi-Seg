...
def prepare_data(data_path, save_img_path, case_index):
...
if __name__ == '__main__':
    ...
    data_path = '/home/moucheng/projects_data/Pulmonary_data/airway/unlabelled/imgs/'
    # lbl_path = '/home/moucheng/projects_data/HipCT/COVID_ML_data/hip_covid/labelled'

    save_img_path = '/home/moucheng/projects_data/HipCT/COVID_ML_data/hip_covid/unlabelled/imgs/'
    # save_lbl_path =
    ...
    for img in all_volumes:
        # print(img)
        # print(lbl)
        case_index = os.path.split(img)[1].split('.')[0]
        # prepare_data(img, lbl, save_img_path)
        prepare_data(img, save_img_path, case_index)
